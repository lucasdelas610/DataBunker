...
Sprint: Claves y Cifrado (Tareas 12-23)
En esta parte del trabajo hemos hecho lo necesario para crear la clave de seguridad y encriptar los archivos.

Qué hemos hecho
Crear la clave: El programa ya sabe generar una clave segura usando Fernet.
...
Para que funcione nuestro código, hay que instalar la librería de criptografía:

pip install cryptography
Cómo probarlo
Hemos hecho unos scripts para ver si funciona todo bien:
